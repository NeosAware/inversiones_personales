...
AUTO_HOLDING_NAME = "Neos Ceramica fiscal valuation stake"


class CeramicaHoldingListView(LoginRequiredMixin, TemplateView):
    template_name = "company/company_dashboard.html"

    def get_context_data(self, **kwargs):
        context = super().get_context_data(**kwargs)
        company_config = NEOS_COMPANY_CONFIG["Neos Ceramica"]
        ...
        context["annual_form"] = kwargs.get(
            "annual_form",
            AnnualCompanyValuationForm(initial={"ownership_pct": Decimal("100.00")}),
        )
