    ...
    context = {
        ...
        "twelve_month_view": {
            ...
            "historical_memory_adjustment": {
                ...
                "historical_average_gap_pct": json_ready_number(memory_feedback.get("average_gap_pct")),
                "recent_average_gap_pct": json_ready_number(memory_feedback.get("recent_average_gap_pct")),
                ...
                "oldest_analysis_date": memory_feedback.get("oldest_analysis_date_label") or "",
                "memory_span_days": int(memory_feedback.get("memory_span_days") or 0),
