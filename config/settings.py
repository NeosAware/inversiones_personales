...
EQUITIES_AUTO_SYNC_ON_VIEW = parse_bool(os.environ.get("APP_EQUITIES_AUTO_SYNC_ON_VIEW"), False)
EQUITIES_IBEX_UNIVERSE_ANALYSIS = parse_bool(os.environ.get("APP_EQUITIES_IBEX_UNIVERSE_ANALYSIS"), True)
EQUITIES_LIVE_IBEX_ON_VIEW = parse_bool(os.environ.get("APP_EQUITIES_LIVE_IBEX_ON_VIEW"), False)
EQUITIES_IBEX_UNIVERSE_LIMIT = parse_int(os.environ.get("APP_EQUITIES_IBEX_UNIVERSE_LIMIT"), 0)
EQUITIES_TRACKING_TARGET_ANNUAL_RETURN_PCT = parse_decimal(
    os.environ.get("APP_EQUITIES_TRACKING_TARGET_ANNUAL_RETURN_PCT"),
    "10.00",
)
...
EQUITIES_NIGHTLY_LLM_INCLUDE_NEWS = parse_bool(os.environ.get("APP_EQUITIES_NIGHTLY_LLM_INCLUDE_NEWS"), True)
EQUITIES_NIGHTLY_LLM_NEWS_SHOCK_REFRESH_ENABLED = parse_bool(
    os.environ.get("APP_EQUITIES_NIGHTLY_LLM_NEWS_SHOCK_REFRESH_ENABLED"),
    True,
)
EQUITIES_NIGHTLY_LLM_COMPANY_NEWS_LOOKBACK_DAYS = parse_int(
    os.environ.get("APP_EQUITIES_NIGHTLY_LLM_COMPANY_NEWS_LOOKBACK_DAYS"),
    12,
)
EQUITIES_NIGHTLY_LLM_SECTOR_NEWS_LOOKBACK_DAYS = parse_int(
    os.environ.get("APP_EQUITIES_NIGHTLY_LLM_SECTOR_NEWS_LOOKBACK_DAYS"),
    10,
)
EQUITIES_NIGHTLY_LLM_MARKET_NEWS_LOOKBACK_DAYS = parse_int(
    os.environ.get("APP_EQUITIES_NIGHTLY_LLM_MARKET_NEWS_LOOKBACK_DAYS"),
    7,
)
EQUITIES_NIGHTLY_LLM_NEWS_MAX_ITEMS = parse_int(
    os.environ.get("APP_EQUITIES_NIGHTLY_LLM_NEWS_MAX_ITEMS"),
    4,
)
EQUITIES_NIGHTLY_LLM_NEWS_TIMEOUT_SECONDS = parse_int(
    os.environ.get("APP_EQUITIES_NIGHTLY_LLM_NEWS_TIMEOUT_SECONDS"),
    10,
)
